...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    dnf install -y http://rpms.remirepo.net/fedora/remi-release-24.rpm
    dnf config-manager --set-enabled remi-php70
    dnf install -y httpd php-fpm php-mysqlnd php-pdo php-pear-phing mariadb-server nano composer npm
