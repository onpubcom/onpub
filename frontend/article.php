...
if ($onpub_article) {
  ...
  if ($onpub_article->imageID) {
    ...
    en('<img src="' . OnpubImages::getThumbURL('src=' . $onpub_article->image->getFullPath() . '&w=400&f=png') . '" align="right" alt="' . $onpub_article->image->fileName . '" title="' . $onpub_article->image->description . '">');
  }
