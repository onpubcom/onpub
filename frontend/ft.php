...
if ($onpub_website) {
  ...
  en('<p>&copy; ' . $dt->format('Y') . ' <a href="index.php">' . $onpub_website->name . '</a>. All rights reserved. <a href="index.php?rss"><img src="' . $onpub_dir_root . $onpub_dir_frontend . 'images/feed-icon-14x14.png" align="top" width="12" height="12" alt="' . $onpub_website->name . ' RSS Feed" title="' . $onpub_website->name . ' RSS Feed"></a></p>');
