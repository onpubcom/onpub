...
if ($onpub_section && $onpub_article) {
  ...
  if ($onpub_article->image) {
    ...
    en('<img src="' . OnpubImages::getThumbURL('src=' . urlencode($onpub_article->image->getFullPath()) . '&w=280&f=png', $onpub_dir_phpthumb) . '" align="right" style="margin-right: 0.75em;" alt="' . $onpub_article->image->fileName . '" title="' . $onpub_article->image->description . '">');
  }
